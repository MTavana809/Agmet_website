...
// Adding Ensembles
  ...
  const layerOptions = [
    { value: 'map1', text: 'Ensemble4' },
    { value: 'map2', text: 'Ensemble5' },
    { value: 'map3', text: 'Ensemble6' },
    { value: 'map4', text: 'Ensemble7' },
  ];
  layerOptions.forEach(option => {
    ...
    optionElement.setAttribute('id', 'selectFilter');
    optionElement.setAttribute('class', 'esri-widget');
    optionElement.setAttribute('style', 'width: 280px;')
  });
  view.ui.add(selector, 'top-right');
    ...
    function changeDescriptors(selectedIndicator) {
        ...
        const htmlContent = HTML30yrmaps + indicators[selectedIndicator].html;
