...
require([
    ...
    function changeIndicator(chosenIndicator) {
        ...
        indicatorVariable.values = yearSlider2.get('values');
    ...
    const yearSlider = new Slider({
        container: 'yearSlider2',
        min: 1961,
        max: 2020,
        values: [1980], // current value shown on load
        precision: 0,
    ...
    function stopAnimation() {
        ...
        timerId = 0;
        playButton2.classList.remove('toggled'); 
    };
